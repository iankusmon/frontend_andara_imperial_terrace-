...
export default function KawasanAIT() {
  ...
  return (
    <div className="relative container mx-auto px-4 py-8 pt-20">
      ...
      Temukan Imperial Dine & Lounge by Andara dengan Pemandangan Sawah Terasering Asri dan Segar!
      </h1>
      ...
      <ShareModal
        ...
        message="Temukan Imperial Dine & Lounge by Andara dengan Pemandangan Sawah Terasering Asri dan Segar!"
