...
const desktopSlides: SlideType[] = [
  { id: 1, image: "/menara_pissa_2.jpg", link: "/artikel/menara-pissa", message: "Lihat Keindahan Menara Pisa!", label: "Menara Pissa!" },
  { id: 2, image: "/colosseum_3.jpg", link: "/artikel/colosseum", message: "Lihat Keindahan Colosseum!", label: "Colosseum!" },
  { id: 3, image: "/venice_canals_2.jpg", link: "/artikel/venice-canals", message: "Lihat Keseruan naik perahu di Venice Canals!", label: "Venice Canals!!" },
